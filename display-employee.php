...
<div class="container-lg-12 ">
    ...
    <div class="container table-container">
        ...
        <div class="d-flex justify-content-between mb-3 btn-search">
            <a class="btn-add" href="add-emp.html">Add Employee</a>
            <!-- <input type="submit" class="btn" value="Add user" /> -->
            <!-- <input type="text" class="form-control w-25" placeholder="Search..."> -->
            <form method="GET" action="display-employee.php" class="d-flex">
                <input type="text" name="search" class="form-control w-75" placeholder="Search employees..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                <button type="submit" class="btn btn-primary ml-4 btn-search-sc">Search</button>
            </form>
            
        </div>
        <h1 class="text-center pb-3">Employee Information</h1>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                include 'php/display-info-employee.php';
                ...
                if (!empty($users)) {
                    foreach ($users as $user) {
                        ...
                        echo "<td><a href='php/edit-emp.php?id={$user['UserID']}' class='btn btn-primary btn-sm button-edit'>Update</a> 
                                  <a href='php/delete-emp.php?id={$user['UserID']}' class='btn btn-danger btn-sm button-delete'>Delete</a></td>";
                        echo "</tr>";
                    }
                } else {
